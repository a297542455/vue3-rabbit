...
const { effectiveListCounts, selectedListCounts, selectedListPrice } =
  storeToRefs(cart);
    ...
    <div class="container">
              ...
              <td colspan="6">
                <div class="cart-none" style="text-align: center">
                  ...
                  <div class="btn" style="margin: 20px">
                    <XtxButton @click="$router.push('/')" type="primary">
                      继续逛逛
                    </XtxButton>
                  </div>
                </div>
      ...
      <div class="action">
        ...
        <div class="total">
          ...
          <XtxButton @click="goToCheckout" type="primary">下单结算</XtxButton>
        </div>
      </div>
    </div>
  </div>
